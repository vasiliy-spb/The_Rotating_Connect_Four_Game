...
public class BoardRotationLeftRightTest {
    ...
    public void testRotateEmptyBoardLeft() {
        Board board = new Board(new DefaultBoardState(Board.Size.ROW6_COLUMN7, getMask(Board.Size.ROW6_COLUMN7))); // DEFAULT: 6x7 (height x width)
    ...
    public void testTokenTransferLeft() {
        Board board = new Board(new DefaultBoardState(Board.Size.ROW6_COLUMN7, getMask(Board.Size.ROW6_COLUMN7)));  // 6x7
        Renderer renderer = new RendererForIdea();
    ...
    public void testBoardDimensionsAfterRotation() {
        ...
        Board boardLeft = new Board(new DefaultBoardState(Board.Size.ROW6_COLUMN7, getMask(Board.Size.ROW6_COLUMN7))); // 6x7
        ...
        Board boardRight = new Board(new DefaultBoardState(Board.Size.ROW6_COLUMN7, getMask(Board.Size.ROW6_COLUMN7))); // 6x7
